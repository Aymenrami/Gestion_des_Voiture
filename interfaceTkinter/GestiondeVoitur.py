...
class voiture:
    ...
    #---------------- Les Outils de conrole de programe ----------------- #
        ...
        ADD_btn = Button(btn_Frame, text='Effacer les données',bg='#566573')
        #ADD_btn.grid(column=0,row =0)
        ADD_btn.place(x=33,y=33,width=150,height=30)
        DEL_btn = Button(btn_Frame, text='Effacer les données',bg='#566573')
        DEL_btn.place(x=33,y=63,width=150,height=30)
        UPDATE_btn = Button(btn_Frame, text='Mise a Jour',bg='#5D6D7E')
        UPDATE_btn.place(x=33,y=93,width=150,height=30)
        CLEAR_btn = Button(btn_Frame, text='Vider le champ',bg='#566573')
        CLEAR_btn.place(x=33,y= 123,width=150,height=30)
        ABOUT_btn = Button(btn_Frame, text='Qui Sommes-nous',bg='#5D6D7E')
        ABOUT_btn.place(x=33,y=153,width=150,height=30)
        EXITE_btn = Button(btn_Frame, text='Fermer le programme',bg='#566573')
